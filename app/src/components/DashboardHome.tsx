                    ...
                    <main className="container mx-auto px-4 py-8 pb-32">
                                                    ...
                                                    <div className="mt-8 pt-6 border-t border-slate-200 dark:border-slate-800 text-left">
                                                        ...
                                                        {myRefCode ? (
                                                            ...
                                                            <div className="relative group">
                                                                <div className={`p-5 rounded-xl border transition-all duration-300 relative overflow-hidden ${lifetimeSpend >= 0.01 ? 'bg-gradient-to-br from-indigo-900/40 to-purple-900/40 border-indigo-500/50 shadow-[0_0_30px_rgba(99,102,241,0.15)]' : 'bg-slate-50 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700/50 blur-[0.5px] opacity-90'}`}>
                                                                    {/* Glassmorphism Shine */}
                                                    ...
                                                    <div className="flex flex-wrap gap-2">
                                                        {history.map((item, i) => (
                                                            <button
                                                                ...
                                                                className="flex items-center gap-2 px-3 py-1.5 bg-slate-50 dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 hover:border-emerald-500/50 active:scale-95 transition-all text-xs font-mono text-slate-600 dark:text-slate-300 group"
                                                            >
                        ...
                        {showPartnerModal && (
                            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-fade-in">
                                <div className="bg-white dark:bg-slate-900 w-full max-w-sm rounded-2xl p-6 shadow-2xl border border-slate-200 dark:border-slate-700 relative overflow-hidden">
                                    {/* Background Decor */}
                                    ...
                                    <button
                                        ...
                                        className="w-full py-3 bg-slate-900 dark:bg-white dark:text-slate-900 text-white font-bold rounded-xl active:scale-95 transition-transform"
                                    >
