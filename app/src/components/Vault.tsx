                                    ...
                                    <div className="w-2/3 p-5 flex flex-col justify-between">
                                        <div>
                                            <div className="flex justify-between items-start mb-2">
                                                ...
                                                <span className="text-[10px] font-mono text-slate-600">{new Date(item.timestamp * 1000).toLocaleDateString()}</span>
                                            </div>
                                        ...
                                        <div className="mt-4 pt-4 border-t border-dashed border-slate-800 flex justify-between items-end">
                                            ...
                                            {item.type === 'audit' && (
                                                <div className="opacity-0 group-hover:opacity-100 transition-opacity">
                                                    <button className="text-[10px] bg-slate-800 hover:bg-slate-700 text-white px-3 py-1 rounded">
                                                        VIEW FULL REPORT
                                                    </button>
                                                </div>
                                            )}
